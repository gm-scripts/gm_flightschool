...
const confValidator: Validator[] = [
  ...
  { name: "prices", name2: "practice", type: "number" },
  ...
  { name: "vehicle", name2: "plane", name3: "model", type: "string" },
  { name: "vehicle", name2: "plane", name3: "color", type: "number" },
  { name: "vehicle", name2: "plane", name3: "livery", type: "number" },
